...
public class ParserTest {
  ...
  static final int[] INPUT_LAYERS = {
    Constant.CABOCHA_INPUT_RAW_SENTENCE,
    Constant.CABOCHA_INPUT_POS,
    Constant.CABOCHA_INPUT_CHUNK,
    Constant.CABOCHA_INPUT_SELECTION,
    Constant.CABOCHA_INPUT_DEP
  };
