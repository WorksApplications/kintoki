...
public class ParamTest {
        ...
        public void open() {
                ...
                String[] args1 = { "-I1", "-O3", "-f2", "-m", dep, "-M", chunk, "-d", dic, "-r", rc, "-o", output, "-v",
                                "-h" };
                String[] args2 = { "--input-layer=1", "--output-layer=3", "--output-format=2", "--parser-model=" + dep,
                                "--chunker-model=" + chunk, "--sudachi-dict=" + dic, "--rcfile=" + rc,
                                "--output=" + output, "--version", "--help" };
        ...
        public void illegalArgumentTest() {
                ...
                String dic = "./";
                String output = "output_file";
                String[] args = { "--I1", "-O3", "-f2", "-m", dep, "-M", chunk, "-d", dic, "-r", rc, "-o", output, "-v",
                                "-h" };
