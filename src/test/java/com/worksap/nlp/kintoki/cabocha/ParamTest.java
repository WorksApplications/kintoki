...
public class ParamTest {
  ...
  static final String systemName =
      System.getProperty("java.home")
          + "/bin/java -jar "
          + new File(Param.class.getProtectionDomain().getCodeSource().getLocation().getPath())
              .getName();
  static final String version = Constant.PACKAGE + " of " + Constant.VERSION + "\n";
  ...
  public void open() {
    ...
    String[] args1 = {
      "-I1", "-O3", "-f2", "-m", dep, "-M", chunk, "-d", dic, "-r", rc, "-o", output, "-v", "-h"
    };
    String[] args2 = {
      "--input-layer=1",
      "--output-layer=3",
