...
public class Parser {
   ...
   *
   * @throws IOException IOexception will be thrown when error occurs in reading files (such as
   *     model file, resource file)
   */
  ...
  private void loadParam(Param param) {
    switch (param.getInt(Param.INPUT_LAYER)) {
      ...
      default:
        throw new IllegalArgumentException(
            "unknown input layer: " + param.getInt(Param.INPUT_LAYER) + "\n");
    }
    switch (param.getInt(Param.OUTPUT_LAYER)) {
      ...
      default:
        throw new IllegalArgumentException(
            "unknown output layer: " + param.getInt(Param.OUTPUT_LAYER) + "\n");
    }
    switch (param.getInt(Param.OUTPUT_FORMAT)) {
      ...
      default:
        throw new IllegalArgumentException(
            "unknown output format: " + param.getInt(Param.OUTPUT_FORMAT) + "\n");
    }
  }
